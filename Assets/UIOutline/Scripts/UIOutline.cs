...
namespace GersonFrame
{
    ...
    {
        public Color MOutlineColor = Color.white;
        [Range(0, 6)] public int MWidth = 0;
        ...
        protected override void Start()
        {
            ...
            var shader = Shader.Find("Gerson/UIOutline");
        ...
        {
            base.graphic.material.SetColor("_OutlineColor", this.MOutlineColor);
            base.graphic.material.SetInt("_OutlineWidth", this.MWidth);
        ...
        private void _ProcessVertices()
        {
            for (int i = 0, count = _vetexList.Count - 3; i <= count; i += 3)
            {
                ...
                //
                v1 = _SetNewPosAndUV(v1, this.MWidth, posCenter, triX, triY, uvX, uvY, uvOrigin);
                v2 = _SetNewPosAndUV(v2, this.MWidth, posCenter, triX, triY, uvX, uvY, uvOrigin);
                v3 = _SetNewPosAndUV(v3, this.MWidth, posCenter, triX, triY, uvX, uvY, uvOrigin);
                // 应用设置后的UIVertex
                //
                _vetexList[i] = v1;
                _vetexList[i + 1] = v2;
